...
const COURSES = [
    ...
    units: [
      {
        ...
        lessons: [
          { id: 'fe-l1', title: 'HTML nima?', icon: 'star', type: 'lesson' },
          { id: 'fe-l2', title: 'Teglar', icon: 'star', type: 'lesson' },
          { id: 'fe-l3', title: 'Mashq', icon: 'dumbbell', type: 'practice' },
          { id: 'fe-l4', title: 'Sarlavhalar', icon: 'star', type: 'lesson' },
          { id: 'fe-l5', title: 'Havolalar', icon: 'star', type: 'lesson' },
          { id: 'fe-l6', title: 'Bo‘lim testi', icon: 'trophy', type: 'review' },
        ],
      },
      {
        id: 'fe-u2',
        ...
        desc: 'Stil berish',
        lessons: [
          { id: 'fe-l7', title: 'CSS nima?', icon: 'star', type: 'lesson' },
          { id: 'fe-l8', title: 'Ranglar', icon: 'star', type: 'lesson' },
          { id: 'fe-l9', title: 'Mashq', icon: 'dumbbell', type: 'practice' },
          { id: 'fe-l10', title: 'Flexbox', icon: 'star', type: 'lesson' },
          { id: 'fe-l11', title: 'Yakuniy test', icon: 'trophy', type: 'review' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    units: [{
      ...
      desc: 'Fizika kirish',
      lessons: [
        { id: 'ph-l1', title: 'Fizika nima?', icon: 'star', type: 'lesson' },
        { id: 'ph-l2', title: 'Harakat', icon: 'star', type: 'lesson' },
        { id: 'ph-l3', title: 'Mashq', icon: 'dumbbell', type: 'practice' },
        { id: 'ph-l4', title: 'Kuch', icon: 'star', type: 'lesson' },
        { id: 'ph-l5', title: 'Test', icon: 'trophy', type: 'review' },
      ],
    }],
  },
  {
    ...
    units: [{
      ...
      lessons: [
        { id: 'bio-l1', title: 'Hujayra', icon: 'star', type: 'lesson' },
        { id: 'bio-l2', title: 'O‘simliklar', icon: 'star', type: 'lesson' },
        { id: 'bio-l3', title: 'Mashq', icon: 'dumbbell', type: 'practice' },
        { id: 'bio-l4', title: 'Hayvonlar', icon: 'star', type: 'lesson' },
  ...
  },
  {
    ...
    units: [{
      ...
      desc: 'Ot, sifat, fe’l',
      lessons: [
        { id: 'uz-l1', title: 'Ot', icon: 'star', type: 'lesson' },
        { id: 'uz-l2', title: 'Sifat', icon: 'star', type: 'lesson' },
        { id: 'uz-l3', title: 'Mashq', icon: 'dumbbell', type: 'practice' },
        { id: 'uz-l4', title: 'Fe’l', icon: 'star', type: 'lesson' },
